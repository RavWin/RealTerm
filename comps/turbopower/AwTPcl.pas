 ...
 *   Sebastian Zierer
 *
 * sjb 25May15  Increase buffers and max buffers to 32K and 16k for max speed.
 *    add aSendFileName    hack to send send file going in aapPrepareReading
 *
 * ***** END LICENSE BLOCK ***** *)
...
const
  ...
  FileBufferSize = 32768; //sjb 8192;     {Size of buffer for receive/xmitting files}
  ...
  apMaxBlockSize = 16512; //sjb was 1024;     {Maximum block size for most protocols}
...
const
  ...
  BPBufferMax      = 16512; //sjb 2048;   {Largest data block available}
...
type
  ...
  TProtocolData = record
    ...
    aSendFileName        : AnsiString;      {sjb hack to send send file going in aapPrepareReading}
