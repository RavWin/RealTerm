 ...
 *    Sebastian Zierer
 *
 * sjb 29May15  Up dispatch rate 20Hz->100Hz for less lumpy send files
 * ***** END LICENSE BLOCK ***** *)
...
const
  ...
  TimerFreq = 10;   //sjb was 50    {Dispatcher timer interval in millisecs Mislabelled is PERIOD not FREQ}
