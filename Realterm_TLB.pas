...
// $Rev: 52393 $
// File generated on 23/10/2017 9:32:07 p.m. from Type Library described below.

// ************************************************************************  //
// Type Lib: C:\l\DXE10\a\realterm\realterm (1)
...
// *********************************************************************//
  IRealtermIntf = interface(IDispatch)
    ...
    procedure PutString(const S: WideString; SendAs: EnumPutStringAs; CRCType: Integer); safecall;
    ...
    property Winsock: Integer read Get_Winsock write Set_Winsock;
  end;
...
// *********************************************************************//
  IRealtermIntfDisp = dispinterface
    ...
    procedure PutString(const S: WideString; SendAs: EnumPutStringAs; CRCType: Integer); dispid 22;
